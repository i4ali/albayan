...
You are generating interactive Quick Overview data for the AlBayan app's verse summary feature. This creates concept bubbles that highlight key insights from each verse.

## ⛔ STRICT FILE RESTRICTIONS ⛔

**DO NOT write to, modify, or merge into `AlBayan/AlBayan/Data/tafsir_*.json` files under ANY circumstances.**
...
3. **Read existing tafsir** (if available) from `AlBayan/AlBayan/Data/tafsir_{surah}.json`
...
- ❌ Writing to `AlBayan/AlBayan/Data/tafsir_*.json` files
