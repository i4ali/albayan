# Validate Tafsir JSON Structure In AlBayan/AlBayan/Data For Given Surah Number
...
Run validation on the specified tafsir file `AlBayan/AlBayan/Data/tafsir_$ARGUMENTS.json` to check:

1. **Top-level structure**: Only numeric verse keys (no metadata or other keys)
2. **All 12 layer keys** present for every verse:
   - English: `layer1`, `layer2`, `layer3`, `layer4`
   - Arabic: `layer1_ar`, `layer2_ar`, `layer3_ar`, `layer4_ar`
   - Urdu: `layer1_urdu`, `layer2_urdu`, `layer3_urdu`, `layer4_urdu`
...
os.chdir('/Users/muhammadimranali/Documents/development/albayan')
...
tafsir_file = f'AlBayan/AlBayan/Data/tafsir_{surah_num}.json'
...
LAYER_KEYS = [
    ...
    'layer1_ar', 'layer2_ar', 'layer3_ar', 'layer4_ar',
    'layer1_urdu', 'layer2_urdu', 'layer3_urdu', 'layer4_urdu',
]
...
if issues:
    ...
    print("   - All 12 layer keys present")
