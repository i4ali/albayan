# Validate All Urdu Tafsir In AlBayan/AlBayan/Data

Validate all tafsir files in `AlBayan/AlBayan/Data/` directory to ensure Urdu translations are complete.

## Task

Run a comprehensive validation of all `AlBayan/AlBayan/Data/tafsir_*.json` files to check:
...
tafsir_files = glob.glob('AlBayan/AlBayan/Data/tafsir_*.json')
