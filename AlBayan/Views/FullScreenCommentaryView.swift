...
#Preview {
    ...
    let sampleTafsir = TafsirVerse(
        ...
        layer4: "**Sunni Perspective**: Sunni commentators like Ibn Kathir focus on the legal framework, emphasizing the guardian's fiduciary duty and the severe punishment for those who consume orphan wealth unjustly. **Shia Perspective**: Classical Shia scholars like Al-Tabatabai emphasize the verse's connection to divine justice (adl), viewing orphan protection as a fundamental test of societal righteousness. **Common Ground**: Both traditions agree on the verse's core message while differing in jurisprudential applications regarding guardianship laws and inheritance distribution.",
        ...
        layer4_urdu: "**سنی نقطہ نظر**: سنی مفسرین جیسے ابن کثیر قانونی فریم ورک پر توجہ دیتے ہیں۔ **شیعہ نقطہ نظر**: کلاسیکی شیعہ علماء جیسے الطباطبائی اس آیت کو الہی عدل سے جوڑتے ہیں۔",
        layer1_ar: nil,
        layer2_ar: nil,
        layer3_ar: nil,
        layer4_ar: nil,
