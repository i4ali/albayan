...
//  AlBayan
//
//  10-day Hajj Journey tab view with progress tracking
//  Only visible during Hajj season
//
...
struct HajjJourneyView: View {
    ...
    @State private var veiledDay: HajjDay?   // locked day being previewed (premium-art 01-A4)
    ...
    var body: some View {
        NavigationView {
            ZStack {
                            ...
                            LazyVStack(spacing: 12) {
                                ...
                                ForEach(journeyManager.days) { day in
                                    HajjDayCard(
                                        ...
                                        isCurrentDay: calendarManager.currentHajjDay() == day.dayNumber,
                ...
                if let day = selectedDay {
                    NavigationLink(
                        destination: HajjDayDetailView(day: day),
        ...
        .sheet(isPresented: $showPaywall) {
            PaywallView(context: PaywallContext(coverAssetName: "JourneyCoverHajj", eyebrow: "DHUL-HIJJAH JOURNEY"))
        }
        .fullScreenCover(item: $veiledDay) { day in
            JourneyDayVeil(
                coverAssetName: "JourneyCoverHajj",
                eyebrow: "HAJJ · DAY \(day.dayNumber)",
                theme: day.theme,
...
struct HajjJourneyHeader: View {
    ...
    var statusMessage: String {
        ...
        switch month {
        case 8: // Sha'ban
            if let daysUntil = calendarManager.daysUntilHajj(), daysUntil > 0 {
                return "\(daysUntil) day\(daysUntil == 1 ? "" : "s") until Hajj"
            }
            return "Hajj begins soon"
        case 9: // Hajj
            return "Day \(day) of Hajj"
        case 10: // Shawwal
            if day <= 5 {
                return "Eid Mubarak!"
            }
            return "Hajj has ended"
        default:
            return "Hajj Journey"
        }
    }
...
private struct HajjLoadingSection: View {
    let message: String
    @StateObject private var themeManager = ThemeManager.shared
