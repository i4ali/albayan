...
struct PropheticStoriesView: View {
    ...
    var body: some View {
                ...
                VStack(spacing: 0) {
                    ...
                    .background(alignment: .top) {
                        if themeManager.isSapphire {
                            ...
                            CoverHeaderBand(assetName: "CoverPropheticStories", height: 280)
                        }
                    }
        ...
        .sheet(isPresented: $showPaywall) {
            PaywallView(context: PaywallContext(coverAssetName: "CoverPropheticStories", eyebrow: "PROPHETIC STORIES"))
        }
    }
}
