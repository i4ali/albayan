            ...
            VStack(spacing: 16) {
                HStack(alignment: .top) {
                    VStack(alignment: .leading, spacing: 6) {
                        // Eyebrow: "30-DAY JOURNEY" uppercase in accentColor
                        Text("30-DAY JOURNEY")
                            .font(SapphireFont.eyebrow)
                            .foregroundColor(themeManager.accentColor)
                            .tracking(3)
                    ...
                    // Icon chip: moon.stars in goldChipFill + accentColor border
                    ZStack {
                ...
                VStack(alignment: .leading, spacing: 10) {
                    HStack(alignment: .center) {
                        VStack(alignment: .leading, spacing: 4) {
                            ...
                            Text("\(journeyManager.completedDaysCount) of 30 days complete")
