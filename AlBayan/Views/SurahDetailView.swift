...
#Preview {
    ...
    let sampleTafsir = TafsirVerse(
        ...
        layer4: "**Shia Analysis**: Focus on divine justice and Imamate principles. **Sunni Analysis**: Emphasis on Caliphate and community consensus. **Common Ground**: Both traditions share core theological foundations while differing in leadership concepts and jurisprudential approaches.",
        layer1_urdu: "بنیادی تفسیر...",
        layer2_urdu: "کلاسیکی تفسیر...",
        layer3_urdu: "عصری تفسیر...",
        layer4_urdu: "**شیعہ تجزیہ**: الہی عدل اور امامت کے اصولوں پر توجہ۔ **سنی تجزیہ**: خلافت اور اجماع امت پر زور۔",
        layer1_ar: nil,
        layer2_ar: nil,
        layer3_ar: nil,
        layer4_ar: nil,
