...
#Preview {
    ...
    let sampleTafsir = TafsirVerse(
        ...
        layer4: "**Sunni Position**: Emphasis on the consensus of the Companions and the established Sunni jurisprudential schools. **Shia Perspective**: Focus on divine justice and the role of the Imams as interpretive authorities. **Common Ground**: Both traditions share core theological foundations while differing in matters of leadership and jurisprudential methodology.",
        layer1_urdu: "بنیادی تفسیر...",
        layer2_urdu: "کلاسیکی تفسیر...",
        layer3_urdu: "عصری تفسیر...",
        layer4_urdu: "**سنی نقطہ نظر**: صحابہ کے اجماع اور سنی فقہی مکاتب پر زور۔ **شیعہ نقطہ نظر**: الہی عدل اور ائمہ کی تفسیری حیثیت پر توجہ۔",
        layer1_ar: nil,
        layer2_ar: nil,
        layer3_ar: nil,
        layer4_ar: nil,
