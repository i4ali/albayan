...
- **Product ID**: `com.albayan.premium.tafsir.discount`
...
```swift
// Add new product ID
private let discountProductID = "com.albayan.premium.tafsir.discount"
...
class PromoOfferManager: ObservableObject {
    ...
    // Local cache key
    private let localCacheKey = "com.albayan.promoOfferSeen"
