...
This document outlines the complete implementation plan for converting AlBayan from a paid app ($0.99) to a **freemium model** with in-app purchases.
...
**Location**: `AlBayan/Services/PurchaseManager.swift`
...
**Location**: `AlBayan/Views/PaywallView.swift`
...
**Location**: `AlBayan/Views/PremiumBadgeView.swift`
...
2. **Create New In-App Purchase**:
   ...
   - **Product ID**: `com.albayan.premium.tafsir`
   - **Price**: Tier 1 ($0.99)
...
for await transaction in Transaction.currentEntitlements
  ↓
if transaction.productID == "com.albayan.premium.tafsir"
  ↓
