...
This document outlines the implementation plan for adding a GitHub-style contribution heatmap to the AlBayan app's ProgressDashboardView. The heatmap will visualize a user's Quranic reading activity over the past year, replacing/enhancing the current basic 7-day weekly calendar.
...
**File Location**: `AlBayan/Views/Components/ReadingHeatmapView.swift`
...
**Location**: `AlBayan/Views/ProgressDashboardView.swift`
