...
## 🎯 Overview
Replace current WelcomeView with an immersive story-driven onboarding that begins with the Hadith of AlBayan and flows into app features with emotional resonance.

## 📖 Onboarding Flow (5 Screens)

### Screen 1: The Hadith (Opening)
- **Hadith of AlBayan quote** in Arabic with English translation
...
### Hadith of AlBayan (Arabic + English):
**Arabic:**
```
